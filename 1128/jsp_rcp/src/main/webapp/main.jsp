	...
	<div class="container">
		...
		<div class="container">
			<div class="main_1 main_common ml-3 mr-5">
				...
				<h3>
					가위<input type="radio"
						style="width: 20px; height: 20px; border: 1px;" name="scissor">
				</h3>
			</div>
			<div class="main_2 main_common mr-5">
				...
				<h3>
					바위<input type="radio"
						style="width: 20px; height: 20px; border: 1px;" name="rock">
				</h3>
			</div>
			<div class="main_3 main_common ">
				...
				<h3>
					보<input type="radio"
						style="width: 20px; height: 20px; border: 1px;" name="paper">
				</h3>
			</div>
		</div>
		...
		<div class="row mt-3">
			<div class="col text-center">
				<button type="button"
					class="btn btn-primary btn-lg mt-lg-5 text-center">
					<a href=result.jsp>Game Start</a></button>
			</div>
		</div>
